    ...
    <div class="attendance__content">
        ...
        <form class="attendance__form" action="/attendance" method="post">
            ...
            <div class="attendance__button">
                @if($status === '勤務外')
                    <button class="attendance__button--submit--clock-in" type="submit" name="action"
                        value="clock_in">出勤</button>
                @elseif($status === '出勤中')
                    <button class="attendance__button--submit--clock-out" type="submit" name="action"
                        value="clock_out">退勤</button>
                    <button class="attendance__button--submit--break-in" type="submit" name="action"
                        value="break_in">休憩入</button>
                @elseif($status === '休憩中')
                    <button class="attendance__button--submit--break-out" type="submit" name="action"
                        value="break_out">休憩戻</button>
                @elseif($status === '退勤済')
